...
loadjs.ready(["wrapper", "head"], function () {
    ...
    fusersadd.lists.is_verified = <?= $Page->is_verified->toClientList($Page) ?>;
...
loadjs.ready(["fusersadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fusersadd", "x_date_of_birth", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fusersadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fusersadd", "x_last_login", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<div class="form-check d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->is_verified->isInvalidClass() ?>" data-table="users" data-field="x_is_verified" name="x_is_verified[]" id="x_is_verified_649629" value="1"<?= ConvertToBool($Page->is_verified->CurrentValue) ? " checked" : "" ?><?= $Page->is_verified->editAttributes() ?> aria-describedby="x_is_verified_help">
...
loadjs.ready(["fusersadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fusersadd", "x_created_at", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fusersadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fusersadd", "x_updated_at", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
