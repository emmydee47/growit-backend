...
class Jobs extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->job_type->Lookup = new Lookup('job_type', 'jobs', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->status->Lookup = new Lookup('status', 'jobs', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_one_completed->Lookup = new Lookup('stage_one_completed', 'jobs', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_two_completed->Lookup = new Lookup('stage_two_completed', 'jobs', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_three_completed->Lookup = new Lookup('stage_three_completed', 'jobs', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"jobs\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jobslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "jobsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jobsadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jobsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("jobsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "jobsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "jobsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("jobsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jobsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("jobsdelete", $this->getUrlParm());
    }
