...
class UsersList extends Users
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->auth_id->AdvancedSearch->toJson(), ","); // Field auth_id
    ...
    protected function restoreFilterList()
    {
        ...
        // Field auth_id
        $this->auth_id->AdvancedSearch->SearchValue = @$filter["x_auth_id"];
        $this->auth_id->AdvancedSearch->SearchOperator = @$filter["z_auth_id"];
        $this->auth_id->AdvancedSearch->SearchCondition = @$filter["v_auth_id"];
        $this->auth_id->AdvancedSearch->SearchValue2 = @$filter["y_auth_id"];
        $this->auth_id->AdvancedSearch->SearchOperator2 = @$filter["w_auth_id"];
        $this->auth_id->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->auth_id); // auth_id
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("auth_id", $this->createColumnOption("auth_id"));
            $option->add("avatar", $this->createColumnOption("avatar"));
            ...
            $option->add("date_of_birth", $this->createColumnOption("date_of_birth"));
            $option->add("last_login", $this->createColumnOption("last_login"));
