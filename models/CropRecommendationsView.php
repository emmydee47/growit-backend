 ...
 * Page class
 */
class CropRecommendationsView extends CropRecommendations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropRecommendationsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "croprecommendationslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "croprecommendationslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "croprecommendationslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
