 ...
 * Page class
 */
class CropStepsAdd extends CropSteps
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropStepsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("cropstepslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "cropstepslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "cropstepsview") {
    ...
    public function renderRow()
    {
        ...
        // step_type
        $this->step_type->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("cropstepslist"), "", $this->TableVar, true);
