...
/**
 * Table class for likes
 */
class Likes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->post_id->DefaultErrorMessage = $Language->phrase("IncorrectGUID");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"likes\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("likeslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "likesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "likesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "likesadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("likesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("likesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "likesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "likesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("likesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("likesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("likesdelete", $this->getUrlParm());
    }
