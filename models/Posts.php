...
class Posts extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->post_type->InputTextType = "text";
        $this->post_type->Nullable = false; // NOT NULL field
        $this->post_type->Required = true; // Required field
        ...
        $this->variety->Nullable = false; // NOT NULL field
        $this->variety->Required = true; // Required field
        ...
        // use_thumbnail
        $this->use_thumbnail = new DbField(
            'posts',
            'posts',
            'x_use_thumbnail',
            'use_thumbnail',
            '"use_thumbnail"',
            'CAST("use_thumbnail" AS varchar(255))',
            11,
            1,
            -1,
            false,
        ...
        $this->use_thumbnail->InputTextType = "text";
        $this->use_thumbnail->DataType = DATATYPE_BOOLEAN;
        $this->use_thumbnail->Lookup = new Lookup('use_thumbnail', 'posts', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->use_thumbnail->OptionCount = 2;
        $this->Fields['use_thumbnail'] = &$this->use_thumbnail;
        ...
        // deleted
        $this->deleted = new DbField(
            'posts',
            'posts',
            'x_deleted',
            'deleted',
            '"deleted"',
            'CAST("deleted" AS varchar(255))',
            11,
            1,
            -1,
            false,
        ...
        $this->deleted->InputTextType = "text";
        $this->deleted->Nullable = false; // NOT NULL field
        $this->deleted->DataType = DATATYPE_BOOLEAN;
        $this->deleted->Lookup = new Lookup('deleted', 'posts', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->deleted->OptionCount = 2;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"posts\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->media_url->DbValue = $row['media_url'];
        $this->thumbnail_url->DbValue = $row['thumbnail_url'];
        $this->use_thumbnail->DbValue = (ConvertToBool($row['use_thumbnail']) ? "1" : "0");
        $this->_content->DbValue = $row['content'];
        $this->deleted->DbValue = (ConvertToBool($row['deleted']) ? "1" : "0");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("postslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "postsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "postsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "postsadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("postsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("postsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "postsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "postsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("postsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("postsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("postsdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        // post_type
        $this->post_type->setupEditAttributes();
        $this->post_type->EditCustomAttributes = "";
        if (!$this->post_type->Raw) {
            $this->post_type->CurrentValue = HtmlDecode($this->post_type->CurrentValue);
        }
        $this->post_type->EditValue = $this->post_type->CurrentValue;
        $this->post_type->PlaceHolder = RemoveHtml($this->post_type->caption());
        ...
        if (!$this->media_url->Raw) {
            $this->media_url->CurrentValue = HtmlDecode($this->media_url->CurrentValue);
        }
        $this->media_url->EditValue = $this->media_url->CurrentValue;
        $this->media_url->PlaceHolder = RemoveHtml($this->media_url->caption());
        ...
        $this->thumbnail_url->EditValue = $this->thumbnail_url->CurrentValue;
        $this->thumbnail_url->PlaceHolder = RemoveHtml($this->thumbnail_url->caption());

        // use_thumbnail
        $this->use_thumbnail->EditCustomAttributes = "";
        $this->use_thumbnail->EditValue = $this->use_thumbnail->options(false);
        $this->use_thumbnail->PlaceHolder = RemoveHtml($this->use_thumbnail->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->post_type);
                    ...
                    $doc->exportCaption($this->use_thumbnail);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->post_type);
                        ...
                        $doc->exportField($this->use_thumbnail);
