 ...
 * Page class
 */
class SuggestionsDelete extends Suggestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SuggestionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("suggestionslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("suggestionslist"); // Return to list
                return;
            }
        }
