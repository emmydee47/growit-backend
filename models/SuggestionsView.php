 ...
 * Page class
 */
class SuggestionsView extends Suggestions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SuggestionsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "suggestionslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "suggestionslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "suggestionslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
