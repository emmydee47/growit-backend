 ...
 * Page class
 */
class JobHistoriesView extends JobHistories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobHistoriesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "jobhistorieslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "jobhistorieslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "jobhistorieslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jobhistorieslist"), "", $this->TableVar, true);
        $pageId = "view";
