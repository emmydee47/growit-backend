...
class Journals extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->journal_type->InputTextType = "text";
        $this->Fields['journal_type'] = &$this->journal_type;
        ...
        $this->deleted->Lookup = new Lookup('deleted', 'journals', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"journals\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->journal_type->DbValue = $row['journal_type'];
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->journal_type->setDbValue($row['journal_type']);
    ...
    public function renderListRow()
    {
        ...
        // journal_type
        $this->journal_type->ViewValue = $this->journal_type->CurrentValue;
        $this->journal_type->ViewCustomAttributes = "";
        ...
        // journal_type
        $this->journal_type->LinkCustomAttributes = "";
        $this->journal_type->HrefValue = "";
        $this->journal_type->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // journal_type
        $this->journal_type->setupEditAttributes();
        $this->journal_type->EditCustomAttributes = "";
        if (!$this->journal_type->Raw) {
            $this->journal_type->CurrentValue = HtmlDecode($this->journal_type->CurrentValue);
        }
        $this->journal_type->EditValue = $this->journal_type->CurrentValue;
        $this->journal_type->PlaceHolder = RemoveHtml($this->journal_type->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->journal_type);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->journal_type);
