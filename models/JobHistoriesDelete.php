 ...
 * Page class
 */
class JobHistoriesDelete extends JobHistories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobHistoriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jobhistorieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jobhistorieslist"); // Return to list
                return;
            }
        }
