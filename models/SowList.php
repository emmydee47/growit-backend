...
/**
 * Table class for Sow List
 */
class SowList extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'SowList';
        $this->TableName = 'Sow List';
        $this->TableType = 'VIEW';
        ...
        $this->stage_one_completed->Lookup = new Lookup('stage_one_completed', 'SowList', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_two_completed->Lookup = new Lookup('stage_two_completed', 'SowList', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_three_completed->Lookup = new Lookup('stage_three_completed', 'SowList', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"Sow List\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("sowlistlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "sowlistview") {
            return $Language->phrase("View");
        } elseif ($pageName == "sowlistedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "sowlistadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("sowlistview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("sowlistview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "sowlistadd?" . $this->getUrlParm($parm);
        } else {
            $url = "sowlistadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("sowlistedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("sowlistadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("sowlistdelete", $this->getUrlParm());
    }
