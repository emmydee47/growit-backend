 ...
 * Page class
 */
class FollowsEdit extends Follows
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FollowsEdit";
    ...
    protected function editRow()
    {
        ...
        // follower
        $this->follower->setDbValueDef($rsnew, $this->follower->CurrentValue, "{00000000-0000-0000-0000-000000000000}", $this->follower->ReadOnly);
