 ...
 * Page class
 */
class PostsDelete extends Posts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PostsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("postslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("postslist"); // Return to list
                return;
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("postslist"), "", $this->TableVar, true);
        $pageId = "delete";
