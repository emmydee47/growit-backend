 ...
 * Page class
 */
class ArticlesEdit extends Articles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticlesEdit";
    ...
    protected function editRow()
    {
        ...
        // usefull_links
        $this->usefull_links->setDbValueDef($rsnew, $this->usefull_links->CurrentValue, "", $this->usefull_links->ReadOnly);
        ...
        // article_category_id
        $this->article_category_id->setDbValueDef($rsnew, $this->article_category_id->CurrentValue, null, $this->article_category_id->ReadOnly);
