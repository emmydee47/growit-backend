...
/**
 * Table class for reminders
 */
class Reminders extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'reminders';
        $this->TableName = 'reminders';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"reminders\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // reminder_date
        $this->reminder_date = new DbField(
            'reminders',
            'reminders',
            'x_reminder_date',
            'reminder_date',
            '"reminder_date"',
            CastDateFieldForLike("\"reminder_date\"", 0, "DB"),
            135,
            8,
            0,
            false,
        ...
        $this->reminder_date->InputTextType = "text";
        $this->reminder_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->Fields['reminder_date'] = &$this->reminder_date;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"reminders\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->reminder_date->DbValue = $row['reminder_date'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("reminderslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "remindersedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "remindersadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("remindersview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("remindersview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "remindersadd?" . $this->getUrlParm($parm);
        } else {
            $url = "remindersadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("remindersedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("remindersadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("remindersdelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->reminder_date->EditValue = FormatDateTime($this->reminder_date->CurrentValue, $this->reminder_date->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->reminder_date);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->reminder_date);
