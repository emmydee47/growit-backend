...
class ArticlesView extends Articles
{
    ...
    // Page object name
    public $PageObjName = "ArticlesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "articleslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "articleslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "articleslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
