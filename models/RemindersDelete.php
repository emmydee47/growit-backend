 ...
 * Page class
 */
class RemindersDelete extends Reminders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RemindersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("reminderslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("reminderslist"); // Return to list
                return;
            }
        }
