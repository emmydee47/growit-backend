 ...
 * Page class
 */
class JobHistoriesEdit extends JobHistories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JobHistoriesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jobhistorieslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "jobhistorieslist") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($curVal != "") {
                ...
                $this->job_id->ViewValue = $this->job_id->Lookup !== null && is_array($this->job_id->lookupOptions()) ? $curVal : null;
            }
            if ($this->job_id->ViewValue !== null) { // Load from cache
                $this->job_id->EditValue = array_values($this->job_id->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = "\"id\"" . SearchString("=", $this->job_id->CurrentValue, DATATYPE_GUID, "");
                }
    ...
    protected function editRow()
    {
        ...
        // job_id
        $this->job_id->setDbValueDef($rsnew, $this->job_id->CurrentValue, "{00000000-0000-0000-0000-000000000000}", $this->job_id->ReadOnly);
