...
/**
 * Table class for post_view_counts
 */
class PostViewCounts extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'post_view_counts';
        $this->TableName = 'post_view_counts';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"post_view_counts\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->view_count = new DbField(
            ...
            'view_count',
            '"view_count"',
            'CAST("view_count" AS varchar(255))',
            3,
            4,
            -1,
            false,
        ...
        $this->view_count->Nullable = false; // NOT NULL field
        $this->view_count->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"post_view_counts\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("postviewcountslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "postviewcountsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "postviewcountsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "postviewcountsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PostViewCountsView";
            case Config("API_ADD_ACTION"):
                return "PostViewCountsAdd";
            case Config("API_EDIT_ACTION"):
                return "PostViewCountsEdit";
            case Config("API_DELETE_ACTION"):
                return "PostViewCountsDelete";
            case Config("API_LIST_ACTION"):
                return "PostViewCountsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("postviewcountsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("postviewcountsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "postviewcountsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "postviewcountsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("postviewcountsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("postviewcountsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("postviewcountsdelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        $this->view_count->ViewCustomAttributes = "";
        ...
        // view_count
        $this->view_count->LinkCustomAttributes = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->view_count->EditCustomAttributes = "";
        ...
        if (!$this->post_id->Raw) {
            $this->post_id->CurrentValue = HtmlDecode($this->post_id->CurrentValue);
        }
