...
class Articles extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // usefull_links
        $this->usefull_links = new DbField(
            'articles',
            'articles',
            'x_usefull_links',
            'usefull_links',
        ...
        $this->usefull_links->InputTextType = "text";
        $this->usefull_links->Nullable = false; // NOT NULL field
        $this->usefull_links->Required = true; // Required field
        $this->Fields['usefull_links'] = &$this->usefull_links;
        ...
        $this->article_category_id = new DbField(
            ...
            'article_category_id',
            '"article_category_id"',
            'CAST("article_category_id" AS varchar(255))',
            72,
            16,
            -1,
            false,
        ...
        $this->article_category_id->Lookup = new Lookup('article_category_id', 'article_categories', false, 'id', ["title","","",""], [], [], [], [], [], [], '', '', "\"title\"");
        $this->article_category_id->DefaultErrorMessage = $Language->phrase("IncorrectGUID");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"articles\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->usefull_links->DbValue = $row['usefull_links'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("articleslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "articlesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "articlesadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("articlesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("articlesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "articlesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "articlesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("articlesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("articlesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("articlesdelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        $this->usefull_links->TooltipValue = "";
        ...
        if ($this->media_url->UseColorbox) {
            ...
            $this->media_url->LinkAttrs["data-rel"] = "articles_x_media_url";
    ...
    public function renderEditRow()
    {
        ...
        $this->usefull_links->EditValue = $this->usefull_links->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->usefull_links);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->usefull_links);
