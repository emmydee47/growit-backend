 ...
 * Page class
 */
class CropsDelete extends Crops
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropsDelete";
    ...
    public function run()
    {
        ...
        $this->companion_crops->Visible = false;
        ...
        if ($filter == "") {
            $this->terminate("cropslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("cropslist"); // Return to list
                return;
            }
        }
