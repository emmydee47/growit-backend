 ...
 * Page class
 */
class CropStepsDelete extends CropSteps
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropStepsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("cropstepslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("cropstepslist"); // Return to list
                return;
            }
        }
