...
/**
 * Table class for suggestions
 */
class Suggestions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'suggestions';
        $this->TableName = 'suggestions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"suggestions\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->month->Lookup = new Lookup('month', 'suggestions', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"suggestions\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("suggestionslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "suggestionsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "suggestionsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "SuggestionsAdd";
            case Config("API_EDIT_ACTION"):
                return "SuggestionsEdit";
            case Config("API_DELETE_ACTION"):
                return "SuggestionsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("suggestionsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("suggestionsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "suggestionsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "suggestionsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("suggestionsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("suggestionsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("suggestionsdelete", $this->getUrlParm());
    }
