...
class UsersAdd extends Users
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // auth_id
        $this->auth_id->setDbValueDef($rsnew, $this->auth_id->CurrentValue, null, false);
        ...
        // date_of_birth
        $this->date_of_birth->setDbValueDef($rsnew, UnFormatDateTime($this->date_of_birth->CurrentValue, $this->date_of_birth->formatPattern()), null, false);

        // biography
        $this->biography->setDbValueDef($rsnew, $this->biography->CurrentValue, null, false);

        // last_login
        $this->last_login->setDbValueDef($rsnew, UnFormatDateTime($this->last_login->CurrentValue, $this->last_login->formatPattern()), null, false);
        ...
        $this->is_verified->setDbValueDef($rsnew, $tmpBool, null, false);
