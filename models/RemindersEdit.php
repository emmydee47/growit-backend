 ...
 * Page class
 */
class RemindersEdit extends Reminders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RemindersEdit";
    ...
    protected function editRow()
    {
        ...
        // reminder_date
        $this->reminder_date->setDbValueDef($rsnew, UnFormatDateTime($this->reminder_date->CurrentValue, $this->reminder_date->formatPattern()), null, $this->reminder_date->ReadOnly);
