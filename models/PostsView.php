    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "postslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "postslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "postslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
