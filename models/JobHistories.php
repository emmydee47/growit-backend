...
/**
 * Table class for job_histories
 */
class JobHistories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'job_histories';
        $this->TableName = 'job_histories';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"job_histories\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->job_id->Lookup = new Lookup('job_id', 'jobs', false, 'id', ["title","job_type","",""], [], [], [], [], [], [], '', '', "\"title\" || '" . ValueSeparator(1, $this->job_id) . "' || \"job_type\"");
        $this->job_id->DefaultErrorMessage = $Language->phrase("IncorrectGUID");
        ...
        $this->job_type->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->job_type->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->job_type->Lookup = new Lookup('job_type', 'job_histories', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        $this->job_type->OptionCount = 3;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"job_histories\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jobhistorieslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jobhistoriesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jobhistoriesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jobhistoriesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JobHistoriesView";
            case Config("API_ADD_ACTION"):
                return "JobHistoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "JobHistoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "JobHistoriesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jobhistoriesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("jobhistoriesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "jobhistoriesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "jobhistoriesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("jobhistoriesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jobhistoriesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("jobhistoriesdelete", $this->getUrlParm());
    }
