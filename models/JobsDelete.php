...
class JobsDelete extends Jobs
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jobslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jobslist"); // Return to list
                return;
            }
        }
