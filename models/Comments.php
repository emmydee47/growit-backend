...
class Comments extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("commentslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "commentsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "commentsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "commentsadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("commentsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("commentsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "commentsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "commentsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("commentsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("commentsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("commentsdelete", $this->getUrlParm());
    }
