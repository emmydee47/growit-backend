 ...
 * Page class
 */
class CropMonthsDelete extends CropMonths
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropMonthsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("cropmonthslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("cropmonthslist"); // Return to list
                return;
            }
        }
