...
/**
 * Table class for token_auths
 */
class TokenAuths extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'token_auths';
        $this->TableName = 'token_auths';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"token_auths\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->otp_token->InputTextType = "text";
        $this->Fields['otp_token'] = &$this->otp_token;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"token_auths\"";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->otp_token->DbValue = $row['otp_token'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tokenauthslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "tokenauthsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "tokenauthsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tokenauthsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TokenAuthsView";
            case Config("API_ADD_ACTION"):
                return "TokenAuthsAdd";
            case Config("API_EDIT_ACTION"):
                return "TokenAuthsEdit";
            case Config("API_DELETE_ACTION"):
                return "TokenAuthsDelete";
            case Config("API_LIST_ACTION"):
                return "TokenAuthsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tokenauthsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tokenauthsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tokenauthsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tokenauthsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("tokenauthsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tokenauthsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tokenauthsdelete", $this->getUrlParm());
    }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->otp_token->setDbValue($row['otp_token']);
    ...
    public function renderListRow()
    {
        ...
        // otp_token
        $this->otp_token->ViewValue = $this->otp_token->CurrentValue;
        $this->otp_token->ViewCustomAttributes = "";
        ...
        // otp_token
        $this->otp_token->LinkCustomAttributes = "";
        $this->otp_token->HrefValue = "";
        $this->otp_token->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // otp_token
        $this->otp_token->setupEditAttributes();
        $this->otp_token->EditCustomAttributes = "";
        if (!$this->otp_token->Raw) {
            $this->otp_token->CurrentValue = HtmlDecode($this->otp_token->CurrentValue);
        }
        $this->otp_token->EditValue = $this->otp_token->CurrentValue;
        $this->otp_token->PlaceHolder = RemoveHtml($this->otp_token->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->otp_token);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->otp_token);
