 ...
 * Page class
 */
class CropStepsView extends CropSteps
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropStepsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "cropstepslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "cropstepslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "cropstepslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
