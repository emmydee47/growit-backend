...
/**
 * Table class for post_bookmarks
 */
class PostBookmarks extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'post_bookmarks';
        $this->TableName = 'post_bookmarks';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "\"post_bookmarks\"";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"post_bookmarks\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("postbookmarkslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "postbookmarksview") {
            return $Language->phrase("View");
        } elseif ($pageName == "postbookmarksedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "postbookmarksadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PostBookmarksView";
            case Config("API_ADD_ACTION"):
                return "PostBookmarksAdd";
            case Config("API_EDIT_ACTION"):
                return "PostBookmarksEdit";
            case Config("API_DELETE_ACTION"):
                return "PostBookmarksDelete";
            case Config("API_LIST_ACTION"):
                return "PostBookmarksList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("postbookmarksview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("postbookmarksview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "postbookmarksadd?" . $this->getUrlParm($parm);
        } else {
            $url = "postbookmarksadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("postbookmarksedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("postbookmarksadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("postbookmarksdelete", $this->getUrlParm());
    }
