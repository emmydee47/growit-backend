 ...
 * Page class
 */
class CropMonthsView extends CropMonths
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CropMonthsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "cropmonthslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "cropmonthslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "cropmonthslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
