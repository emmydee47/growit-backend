 ...
 * Page class
 */
class ArticlesDelete extends Articles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticlesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("articleslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("articleslist"); // Return to list
                return;
            }
        }
