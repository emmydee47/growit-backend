 ...
 * Page class
 */
class RemindersView extends Reminders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RemindersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "reminderslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "reminderslist"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "reminderslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
