...
/**
 * Table class for Harvest List
 */
class HarvestList extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'HarvestList';
        $this->TableName = 'Harvest List';
        $this->TableType = 'VIEW';
        ...
        $this->stage_one_completed->Lookup = new Lookup('stage_one_completed', 'HarvestList', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_two_completed->Lookup = new Lookup('stage_two_completed', 'HarvestList', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
        ...
        $this->stage_three_completed->Lookup = new Lookup('stage_three_completed', 'HarvestList', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "\"Harvest List\"";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("harvestlistlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "harvestlistview") {
            return $Language->phrase("View");
        } elseif ($pageName == "harvestlistedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "harvestlistadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "HarvestListAdd";
            case Config("API_EDIT_ACTION"):
                return "HarvestListEdit";
            case Config("API_DELETE_ACTION"):
                return "HarvestListDelete";
            case Config("API_LIST_ACTION"):
                return "HarvestListList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("harvestlistview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("harvestlistview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "harvestlistadd?" . $this->getUrlParm($parm);
        } else {
            $url = "harvestlistadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("harvestlistedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("harvestlistadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("harvestlistdelete", $this->getUrlParm());
    }
